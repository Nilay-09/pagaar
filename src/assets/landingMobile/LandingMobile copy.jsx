...
export default function LandingMobile() {
  return (
    <div className="w-screen min-h-screen relative">
      ...
      <div className="w-full h-[373px] bg-red-300 mt-[65px]"></div>
      <div className="w-full min-h-max px-6 py-[30px] urbanist-800 text-[48px] leading-[56px] bg-[#683BE8] text-white">
        Get instant real-time alerts of all the openings on the internet
      </div>
      <div className="w-full h-[420px] -mt-[1px]">
        <img src={Earth} alt="" className="w-full h-full object-cover" />
      </div>
      ...
      <div className="footer w-full mt-[100px] min-h-[442px] flex pt-[10px] pb-[52px]">
